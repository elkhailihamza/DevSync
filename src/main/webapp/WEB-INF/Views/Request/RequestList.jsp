  ...
  <div class="relative overflow-x-auto">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      ...
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        ...
        <td class="px-6 py-4">
          <form action="${pageContext.request.contextPath}/tasks/request/accept?id=<%= taskRequest.getId() %>" method="post">
            <button class="p-2 bg-green-500 hover:bg-green-800 transition-all">
          ...
          <form action="${pageContext.request.contextPath}/tasks/request/decline?id=<%= taskRequest.getId() %>" method="post">
            <button class="p-2 bg-red-500 hover:bg-green-800 transition-all">
